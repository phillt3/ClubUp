...
struct ClubDetailView: View {
                ...
                VStack {
                    ...
                    ZStack {
                        RoundedRectangle(cornerRadius: 10)
                            .fill(LinearGradient(gradient: Gradient(colors: [Color.blue, Color("Sky_Blue")]), startPoint: .topLeading, endPoint: .bottomTrailing))
                        ...
                        HStack {
                            ...
                            if (prefs.distanceUnit == Unit.Imperial) {
                                DistanceTextField(value: $club.distanceYards)
                            } else if (prefs.distanceUnit == Unit.Metric) {
                                DistanceTextField(value: $club.distanceMeters)
                            }
                        }
                        .padding()
                    }
    ...
    /// Determine which distance unit to display
    @ViewBuilder
    func DistanceTextField(value: Binding<Int?>) -> some View {
